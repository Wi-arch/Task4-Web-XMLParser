...
public class StAXParserCommand implements Command {
    ...
    private static final Logger LOGGER = LogManager.getLogger(StAXParserCommand.class);
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            List<Gem> gemList = ParserService.getInstance().parseXML(filePart, GemBuilderFactory.getInstance().getStAXGemBuilder());
